    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                <x-nav-link :href="route('user.event')" :active="request()->routeIs('user.event')">
                    {{ __('Semua Acara') }}
                </x-nav-link>
            </div>
          </li>
          <li class="nav-item">
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                <x-nav-link :href="route('user.event.myEvent')" :active="request()->routeIs('user.event.myEvent')">
                    {{ __('Acara yang diikuti') }}
                </x-nav-link>
            </div>
          </li>
          <li class="nav-item">
